...
- **settings.json file change** [v1]: **_settings.json_** file এ গিয়ে নিচের code টাকে use করতে হবে,
  ...
  - **theme install** :
    ...
    3. **bothend**: **_Community Material Theme_** by Mattia Astorino **_Community Material Theme High Contrst_**
...
- **settings.json file change** [for **_eslint & prettier_**]: **_settings.json_** file এ গিয়ে নিচের code টাকে use করতে হবে,
...
* **_settings sync_** :
  1.Personal access tokens: **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**
